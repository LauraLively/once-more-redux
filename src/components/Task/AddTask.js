...
class AddTask extends Component {
    ...
    handleUpdateList = async (event) => {
        await fetch(`${apiURL}/listByTaskUpdate/${this.props.list._id}`, {
            method: "PATCH",
            body: JSON.stringify({ taskId: this.taskIds }),
            headers: {
                'Accept': 'application/json', //needed to actually change info and not empty object. 
